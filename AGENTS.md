...
This project is indexed by GitNexus as **crypto-quant** (1101 symbols, 1892 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
