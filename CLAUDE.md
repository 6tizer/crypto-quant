...
This project is indexed by GitNexus as **crypto-quant** (845 symbols, 1413 relationships, 54 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
